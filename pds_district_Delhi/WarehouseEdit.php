...
<script>
                             ...
                             <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Wheat Quantity in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="storage" name="storage" value="<?php echo $storage ?>" required />
                                                    </div>
                                                    <span class="help-block">Wheat Quantity in Quintals</span>
                                                </div>
                                            </div>
											
											<div class="form-group">
                                                <label class="col-md-3 control-label">Rice Quantity in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="storage1" name="storage1" value="<?php echo $storage1 ?>" required />
                                                    </div>
                                                    <span class="help-block">Rice Quantity in Quintals</span>
                                                </div>
                                            </div>
    ...
    <!-- START SCRIPTS -->
		...
		function showPopup() {
			...
			var storage1 = document.getElementById('storage1').value;
            var district = document.getElementById('district').value;
            var warehousetype = document.getElementById('warehousetype').value;

            if (name === '' || type === '' || latitude === '' || longitude === '' || id === '' || storage === '' || storage1 === '' ||district === '' || warehousetype === '') {
