                             ...
                             <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Wheat in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="storage" name="storage" required />
                                                    </div>
                                                    <span class="help-block">Wheat in Quintals</span>
                                                </div>
                                            </div>
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <span class="help-block">FRice in Quintals</span>
                                                </div>
                                            </div>
								...
								<div id="popup" class="popup">
										...
										<center><button class="btn btn-primary" onclick="verifyCaptcha()">Verify</button></center>r>
								</div>
                            </div>
                            </form>
