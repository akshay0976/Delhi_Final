...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Madhya Pradesh PDS Route Optimization</li>
</ul>
<!-- END BREADCRUMB -->
<div>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: center;">
					<h1 style="font-weight: bold; color: #335566;">Madhya Pradesh PDS Route Optimization</h1>
							...
							<div class="row">
								...
								<div class="col-md-4 mb-4">
									<div class="card h-100"
										...
										<div style="font-size:14px">Total Warehouse FRice Demands (Qtl)</div>
									</div>
								</div>
								<div class="col-md-4 mb-4">
									<div class="card h-100"
