...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Delhi PDS Route Optimisation</li>
</ul>
<!-- END BREADCRUMB -->
<div>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: center;">
					<h1 style="font-weight: bold; color: #335566;">Delhi PDS Route Optimisation</h1>
					<h1 style="font-weight: bold; color: #FF6666;">Kindly Optimise the Leg2 FCI to FPS</h1>
							...
							<div class="row">
								...
								<div class="col-md-4 mb-4">
									<div class="card h-100"
										...
										<div style="font-size:20px" id="total_supply_wheat"></div>
										<div style="font-size:14px">Total Wheat Quantity (Qtl)</div>
									</div>
								</div>
								<div class="col-md-4 mb-4">
									<div class="card h-100"
										style="background-color:#DA867A; color:white; padding:12px; font-weight: bold;">
										<div style="font-size:20px" id="total_supply_frice"></div>
										<div style="font-size:14px">Total FRice Quantity (Qtl)</div>
									</div>
								</div>
								<br><br><br><br><br>
						...
						.then(data => {
							...
							fetch(pythonUrl + 'getfcidata', {
								...
								.then(data => {
									...
									document.getElementById("total_supply_wheat").innerHTML = formatNumberWithCommasWithoutDecimal(data["Total_Supply_Wheat"]);
